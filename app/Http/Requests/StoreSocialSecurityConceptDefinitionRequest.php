...
class StoreSocialSecurityConceptDefinitionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'code' => [
                ...
                Rule::unique('social_security_concept_definitions', 'code')->where('company_id', app(CurrentCompany::class)->id()),
            ],
